...
import { URL_PROFILE,URL_UPDATE_PASSWORD } from "../../constants/urls/urlFrontEnd";
...
const updateOneUser = () => {
    ...
    return (
        ...
        <button onClick={updatePassword} className="btn w-96 rounded-sm hover:bg-dark-pink text-white bg-light-pink hover:scale-105 active:scale-100 active:duration-100 duration-500">Modifier votre mot de passe</button>
        </div>
        </>
    );
};
